...
_ONE_TIME: List[CalTestDef] = [
    ...
    CalTestDef(
        ...
        pass_criteria={"peak_to_peak_mm_max": 0.25, "preferred_mm_max": 0.15},
    ),
]
...
_GATE: List[CalTestDef] = [
    CalTestDef(
        ...
        description="100 mm coupon; CNC |error| ≤ 0.10 mm (fixture 0.15 / shop 0.20).",
        ...
        pass_criteria={"abs_error_mm_max": 0.10, "aim_mm_max": 0.05},
    ),
    CalTestDef(
        ...
        category=CalCategory.GATE,
        phase=CalPhase.DIMENSIONAL,
        description="Same G-code 3×; CNC span ≤ 0.05 mm + Cpk ≥ 1.0 on 100 mm feature.",
        requires_filament=True,
        duration_min=180.0,
        prerequisites=("dimensional_accuracy",),
        capture_fields=("measurements_mm", "span_mm", "mean_error_mm", "cpk"),
        pass_criteria={"span_mm_max": 0.05, "cpk_min": 1.0},
    ),
    CalTestDef(
        id="speed_regression",
    ...
    CalTestDef(
        ...
        category=CalCategory.GATE,
        phase=CalPhase.DIMENSIONAL,
        description="Pre/post anneal measure; post-anneal within CNC band with compensation.",
        requires_filament=True,
        duration_min=240.0,
        prerequisites=("dimensional_accuracy",),
        capture_fields=("pre_anneal_mm", "post_anneal_mm", "shrink_percent"),
        pass_criteria={"post_abs_error_mm_max": 0.10},
    ),
    CalTestDef(
        id="reliability_soak",
