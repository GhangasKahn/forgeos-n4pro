...
| Param | Value |
|---|---|
| **Z adjust** | **+0.90 mm** (homing_origin Z) |
| Bed | **65 °C** dual zone |
| Nozzle | **214 °C** |
| Soak | **5 min** |
...
4. Settled operator **good enough ~0.90** → used for G3 bar  
...
| Z-tune | Multiple runs; **good enough** at Z=0.90 |
...
- Password for sudo on printer often `makerbase`  
